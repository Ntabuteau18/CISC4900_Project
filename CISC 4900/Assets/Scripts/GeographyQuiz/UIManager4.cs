...
[Serializable()]
public struct UIManagerParameters4
{
...
public class UIManager4 : MonoBehaviour
{
    ...
    [SerializeField] AnswerList4 answerPrefab = null;
    [SerializeField] UIElements4 uIElements = new UIElements4();

    [Space]
    [SerializeField] UIManagerParameters4 parameters = new UIManagerParameters4();

    List<AnswerList4> currentAnswer = new List<AnswerList4>();
    ...
    void UpdateQuestionUI(QuestionList4 question)
    {
    ...
    void CreateAnswers(QuestionList4 question)
    {
        EraseAnswers();
        ...
        {
            AnswerList4 newAnswer = (AnswerList4)Instantiate(answerPrefab, uIElements.AnswersContentArea);
